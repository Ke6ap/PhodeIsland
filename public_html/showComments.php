...
<head>
    ...
    <link rel="stylesheet" href="CSS/style_showComments.css">
...
<body>
    ...
    <div class="container-fluid cont">
        <div class="row">
            <div class="col-md-6">
                <h1 style="text-align: center; margin-top:5px;">Your Comments</h1>
                <?php getYourComments($con,$user_data) ?>
            </div>
            <div class="col-md-6">
                <h1 style="text-align: center;margin-top:5px;">All Comments</h1>
                <?php getAllComments($con) ?>
            </div>
        </div>
    </div>
