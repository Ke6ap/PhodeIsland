...
<html lang="en">
  <head>
    ...
    <body>
       ...
       <nav class="navbar-custom navbar navbar-expand-md navbar-dark sticky-top">
       ...
       <div class="main-image">
           <div class="banner-container">
               ...
               <a class="button" target="_blank" href="reservation_form.php">Reservation</a>
           </div>
       </div>
                ...
                <div class="col-md-4">
                    <div class="food-card card">
                        ...
                        <div class="card-body">
                            ...
                            <a href="menu.php#salad" class="btn btn-outline-secondary">See All</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="food-card card">
                        ...
                        <div class="card-body">
                            ...
                            <a href="menu.php#maindish" class="btn btn-outline-secondary">See All</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="food-card card">
                        ...
                        <div class="card-body">
                            ...
                            <a href="menu.php#seaF" class="btn btn-outline-secondary ">See All</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        echo"<div class='container-fluid padding' style='margin-top=20px;'>
            ...
            <div class='row'>
                <form method='POST' action='".setComment($con,$user_data)."' class='col-lg-6 col-md-5'>
                    ...
                    <a href='showComments.php' style='color:black;'>See Comments</a>
                </form>
        ...
        <footer class="container-fluid padding" style="margin-top: 20px;">
            <div class="row text-center">
              ...
              <div class="col-md-4">
                ...
                <hr class="light">
                <p>Monday 6pm-12pm</p>
                <p>Wednesday 6pm-12pm</p>
                <p>Friday-Sunday 6pm-1am</p>
              </div>
              <div class="col-md-4">
                <hr class="light">
                <h3>Follow Us</h3>
